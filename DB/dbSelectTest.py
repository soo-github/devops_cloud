...
# sql ="SELECT userID, name, birthYear, add, CONCAT(mobile1,'-', mobile2) AS mobile, height, mDate FROM userTBL"
# select 쿼리에서 NULL처리
...
while(True) :
    ...
    print("%5s %5s %d %5s %10s %d" % (userID, name, birthYear, addr, mobile, height, mDate))
